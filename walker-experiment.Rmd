...
```{r brms models}
full_prototype <- brm(PcongruentAdj ~ Term + (1|Participant),
                     family=Beta(),
                     data=vertical_distance,
                     chains=0, # this means that model is never sampled
                     prior=c(prior(normal(0, 1), class="b")))

intercept_prototype <- brm(PcongruentAdj ~ (1|Participant),
                           family=Beta(),
                           chains=0, # this means that model is never sampled
                           data=vertical_distance)

factor_prototype <- brm(PcongruentAdj ~ TermAsFactor + (1|Participant),
                        family=Beta(),
                        data=vertical_distance,
                        chains=0, # this means that model is never sampled
                        prior=c(prior(normal(0,1), class="b")))
...
sphere_ambiguity_fit_predictions <- 
  predict(sphere_ambiguity_full_model,
