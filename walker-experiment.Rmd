...
ggsave('figure-03-walker-distance.png', width=18.3, height=14, units="cm")
ggsave('figure-03-walker-distance.svg', width=18.3, height=14, units="cm")
...
# ggsave('figure-05-walker.pdf', width=14, height=20, units="cm", device=cairo_pdf)
ggsave('figure-04-walker-ambiguity.png', width=18.3, height=14, units="cm")
ggsave('figure-04-walker-ambiguity.svg', width=18.3, height=14, units="cm")
```
...
# ggsave('figure-05-walker.pdf', width=14, height=20, units="cm", device=cairo_pdf)
ggsave('figure-05-walker-single.png', width=18.3, height=14, units="cm")
ggsave('figure-05-walker-single.svg', width=18.3, height=14, units="cm")
```