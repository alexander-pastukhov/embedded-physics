...
ggsave('Figures/figure-03-walker-distance.png', width=18.3, height=14, units="cm")
ggsave('Figures/figure-03-walker-distance.svg', width=18.3, height=14, units="cm")
...
ggsave('Figures/figure-04-walker-ambiguity.png', width=18.3, height=14, units="cm")
ggsave('Figures/figure-04-walker-ambiguity.svg', width=18.3, height=14, units="cm")
```
...
SOR_walker_plot <-
  ...
  geom_quasirandom(data=SOR_walker, method="tukeyDense", width=0.2,
                  aes(x=ShiftAbs, group=ShiftAbs, y=Pcongruent)) +
  scale_x_continuous(name = "Shift (degrees)", limits= c(-0.09, 1.09), breaks = unique(SOR_walker$ShiftAbs),
                     sec.axis =  dup_axis(name=NULL, labels=compute_factor_level_predicted_difference(SOR_walker_pairwise_comparison))) +
  scale_y_continuous(name="Pcongruent", limits= c(0, 1), breaks = c(0, 0.25, 0.5, 0.75, 1)) +
  plot_theme()
SOR_walker_plot
...
SOR_sphere_plot <-
  ...
  geom_quasirandom(data=SOR_sphere, method="tukeyDense", width=0.2,
                  aes(x=ShiftAbs, group=ShiftAbs, y=Pcongruent)) +
  scale_x_continuous(name = "Shift (degrees)", limits= c(0, 1),breaks = unique(SOR_sphere$ShiftAbs),
                     sec.axis =  dup_axis(name=NULL, labels=compute_factor_level_predicted_difference(SOR_sphere_pairwise_comparison))) +
  scale_y_continuous(name="Pconsistent", limits= c(0.9, 1.025), breaks = c(0.9, 0.95,1)) +
  plot_theme()
...
# ggsave('Figures/figure-05-walker.pdf', width=14, height=20, units="cm", device=cairo_pdf)
ggsave('Figures/figure-05-walker-single.png', width=18.3, height=14, units="cm")
ggsave('Figures/figure-05-walker-single.svg', width=18.3, height=14, units="cm")
```