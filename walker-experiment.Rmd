...
#BF_vertical_distance%>%
 # dplyr::mutate(BF_vertical_distanceNumeric= as.numeric(BF_vertical_distance))
#BF_vertical_distance_rounded <- round(BF_vertical_distanceNumeric ,digits=2)

BF_vertical_distance_rounded <- round(BF_vertical_distance,digits=2)
