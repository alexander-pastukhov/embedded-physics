...
physics_prototype <- brm(PconruentAdj ~ NotInteracting + (1|Participant),
                          family=Beta(),
                          data=vertical_distance,
                          chains=0,
                          prior=c(prior(normal(0, 1), class="b")))
...
vertical_distance_alpha <- compute_full_model_alpha(vertical_perceptual_coupling_model)
vertical_distance_beta <- compute_full_model_beta(vertical_perceptual_coupling_model)  

# Compare the two models with term (full) and without it (intercept)
vertical_distance_comparison <- compare_models(vertical_perceptual_coupling_model,vertical_independent_model)
...
set.seed(5515605 )
horizontal_distance_full_model <- fit_prototype(perceptual_coupling_prototype, horizontal_distance)
horizontal_distance_intercept_model <- fit_prototype(independent_prototype, horizontal_distance)
horizontal_distance_factor_model <- fit_prototype(pairwise_comparison_prototype, horizontal_distance, add_loo = FALSE)
```
...
set.seed(5515605 )
sphere_ambiguity_full_model <- fit_prototype(perceptual_coupling_prototype, sphere_ambiguity)
sphere_ambiguity_intercept_model <- fit_prototype(independent_prototype, sphere_ambiguity)
sphere_ambiguity_factor_model <- fit_prototype(pairwise_comparison_prototype, sphere_ambiguity, add_loo = FALSE)
```
...
set.seed(5515605 )
walker_ambiguity_full_model <- fit_prototype(perceptual_coupling_prototype, walker_ambiguity)
walker_ambiguity_intercept_model <- fit_prototype(independent_prototype, walker_ambiguity)
walker_ambiguity_factor_model <- fit_prototype(pairwise_comparison_prototype, walker_ambiguity, add_loo = FALSE)
```
...
SOR_walker_full_model <- fit_prototype(perceptual_coupling_prototype, SOR_walker)
SOR_walker_intercept_model <- fit_prototype(independent_prototype, SOR_walker)
SOR_walker_factor_model <- fit_prototype(pairwise_comparison_prototype, SOR_walker, add_loo = FALSE)
```
...
set.seed(5515605 )
# error here: 'beta' requires response greater than zero
SOR_sphere_full_model <- fit_prototype(perceptual_coupling_prototype, SOR_sphere)
SOR_sphere_intercept_model <- fit_prototype(independent_prototype, SOR_sphere)
SOR_sphere_factor_model <- fit_prototype(pairwise_comparison_prototype, SOR_sphere, add_loo = FALSE)
```
