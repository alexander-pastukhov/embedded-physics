...
sphere_ambiguity_plot <-
  ...
  geom_line() +
  geom_hline(yintercept = 0.5, color="white", size= 1) +
  geom_quasirandom(data=sphere_ambiguity, method="tukeyDense", width=0.2,
...
walker_ambiguity_plot <-
  ...
  scale_x_continuous(name = "Walker Disambiguation (degrees)", breaks = unique(walker_ambiguity$WalkerDisambiguationAbs),
