...
horizontal_distance_plot_main <-
  ...
  scale_y_continuous(name="Pcongruent") +
  plot_theme +
   labs(subtitle=glue("β = {horizontal_distance_summary$Value[1]}, CI={horizontal_distance_summary$Value[2]}, ΔELPD={horizontal_distance_summary$Value[3]} , Weight={horizontal_distance_summary$Value[4]}, Bayes factor= {BF_horizontal_distance_rounded}"))+
...
sphere_ambiguity_plot_main <-
 ...
 scale_x_continuous(name = "Sphere Disambiguation", breaks = unique(sphere_ambiguity$SphereDisambiguationAbs), 
  ...
  scale_y_continuous(name="Pcongruent") +
  plot_theme +
  labs(subtitle=glue("β = {sphere_ambiguity_summary$Value[1]}, CI={sphere_ambiguity_summary$Value[2]}, ΔELPD={sphere_ambiguity_summary$Value[3]} , Weight={sphere_ambiguity_summary$Value[4]}, Bayes factor= {BF_sphere_ambiguity_rounded}"))+
    theme(legend.position = "none",
        axis.text.x.top = element_text())
sphere_ambiguity_plot_main
...
walker_ambiguity_plot_main <-
 ...
 scale_x_continuous(name = "Walker Disambiguation", breaks = unique(walker_ambiguity$WalkerDisambiguationAbs), 
  ...
  scale_y_continuous(name="Pcongruent") +
  plot_theme +
  labs(subtitle=glue("β = {walker_ambiguity_summary$Value[1]}, CI={walker_ambiguity_summary$Value[2]}, ΔELPD={walker_ambiguity_summary$Value[3]} , Weight={walker_ambiguity_summary$Value[4]}, Bayes Factor= {BF_walker_ambiguity_rounded}"))+
