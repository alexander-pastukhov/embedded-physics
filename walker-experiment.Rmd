...
sphere_ambiguity_compare <- loo::loo_compare(list("Sphere Disambiguation" = sphere_ambiguity_as_factor_fit$criteria$loo,
                                          "Intercept" = sphere_ambiguity_null_model$criteria$loo))

sphere_ambiguity_weight <- loo::loo_model_weights(list("Sphere Disambiguation" = sphere_ambiguity_as_factor_fit$criteria$loo,
                                               "Intercept" = sphere_ambiguity_null_model$criteria$loo))
