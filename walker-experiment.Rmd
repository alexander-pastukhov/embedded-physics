...
vertical_distancePlot_main <-
  ...
  geom_quasirandom(data=vertical_distance, method="tukeyDense", width=2,
                aes(x=Distance, group=Distance, y=Pcongruent)) + 
  scale_x_continuous(name = "Distance [%]",limits=c(-1,5),breaks=unique(vertical_distance$Distance),
...
```{r final Plot horizontal distance}
horizontal_distancePlot_main <-
  ...
  geom_quasirandom(data=horizontal_distance, method="tukeyDense", width=2,
                aes(x=Distance, group=Distance, y=Pcongruent)) + 
  scale_x_continuous(name = "Distance [%]", breaks = unique(horizontal_distance$Distance),
...
#ggsave(horizontal_distancePlot_main, filename = "walker-horizontal-distance.png", units="cm", width=14, height=8)
#ggsave(horizontal_distancePlot_main, filename = "walker-horizontal-distance.pdf", units="cm", width=14, height=8, device=cairo_pdf)
```
