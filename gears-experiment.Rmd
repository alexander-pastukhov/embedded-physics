...
set.seed(9578175)
distance_full_model <- fit_prototype(perceptual_coupling_prototype, distance)
distance_independent_model <- fit_prototype(independent_prototype, distance)
distance_factor_model <- fit_prototype(pairwise_comparison_prototype, distance, add_loo = FALSE)
```
