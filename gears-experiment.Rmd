...
reports <- 
  ...
  mutate(Percept=as.factor(Percept),
         Percept=fct_recode(Percept, "Counterrotation"="up","down", "Corotation"="left", "right"), DisplayLeft=fct_recode(DisplayLeft, "easy"="gear24-strong", "medium"="gear24-medium-strong", "hard"="gear24-weak", "full"= "gear24"), 
