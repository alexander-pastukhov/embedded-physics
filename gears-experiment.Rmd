...
occlusion<- reports%>%
 ...
 # duplicating Occlusion as Term for common BRMS model use
  ...
  dplyr::mutate(NotInteracting= as.integer((Occlusion > "-8.13")))# since distance is not part of the data anymore and we know it can always interact, I am just trying sth here
...
occlusion_comparison <- compare_models(occlusion_perceptual_coupling, occlusion_independent_model)
