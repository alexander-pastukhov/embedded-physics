...
loo::loo_compare(list("Ambiguity" = ambiguity_as_factor_fit$criteria$loo, "Intercept" = ambiguity_null_model$criteria$loo))

loo::loo_model_weights(list("Ambiguity" = ambiguity_as_factor_fit$criteria$loo, "Intercept" = ambiguity_null_model$criteria$loo))
