...
ggsave('figure-02-gears.png', width=18.3, height=14, units="cm")
ggsave('figure-02-gears.svg', width=18.3, height=14, units="cm")
```
...
ggsave("figure-s01.png", units="cm", width=18.3, height=7)
ggsave("figure-s01.pdf", units="cm", width=18.3, height=7, device=cairo_pdf)
ggsave("figure-s01.svg", units="cm", width=18.3, height=7)
```
